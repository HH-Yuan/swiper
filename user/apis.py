...
def verify_phone(request):
    ...
    if is_phone_num(phone_num):
        ...
        if logics.send_verify_code(phone_num):
            ...
            return render_json(code=common.errors.SMS_SEND_ERR)
    else:
        return render_json(code=common.errors.PHONE_NUM_ERR)
...
def login(request):
    ...
    if cached_code != code:
        return render_json(code=common.errors.VERIFY_CODE_ERR)
